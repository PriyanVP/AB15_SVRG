...
class Command(Enum):
    ...
    READ_REG                    = 4              # read single register, output data in raw format, reports error if unsuccessful
    WRITE_REG                   = 5              # write single register, output data in raw format, reports error if unsuccessful
    CONFIGURE_READING           = 6              # reconfigure continuos reading (table, periodicity, etc.)
    ...
    FLM_DIAG_ENABLE             = 23             # enables Firing Loop Module cyclic diagnostics
    FLM_DIAG_READ_RESULTS       = 24             # returns results of Firing Loop Module cyclic diagnostics
    ...
    START_HACKED_TIMER          = 32             # 
    STOP_HACKED_TIMER           = 33             #

    RESET_MCU                   = 34             # reset ShieldBuddy board
    SET_SVR                     = 35             # set SVR pin
    ...
    INT_CMD_ACK_WATCHDOG1       = 65             # acknowledge watchdog 1
    INT_CMD_ACK_WATCHDOG2       = 66             # acknowledge watchdog 2
    INT_CMD_READ_WD_STATUS      = 67             # read watchdogs status registers
    INT_CMD_EXECUTE_TEST_MODE   = 68             # execute 1 iteration of test mode 1/2 
    INT_CMD_EXECUTE_HACKED_TIMER= 69             #  
