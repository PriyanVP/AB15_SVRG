...
//             ConfigureTimerPeriodicity(GPIO_TIMER, continuousReadPeriodicity); // TODO: can be calculated on MCU side
...
//             EnableTimerInterrupt(GPIO_TIMER);
...
//     DisableTimerInterrupt(GPIO_TIMER);
