...
typedef enum
{
    ...
    USB_CMD_SPI_INSTR_NO_DATA           = 2,                  /** \brief execute SPI instruction without 16bit input data */
    USB_CMD_SPI_INSTR_16B_DATA          = 3,                  /** \brief execute SPI instruction with 16bit input data (send via payload) */
    USB_CMD_READ_DEV_ID                 = 4,                  /** \brief reads ASIC Device ID, reports error if unsuccessful */
...
//    USB_CMD_ACTIVATE_MCU                = 25,                 /** \brief activates MCU, exits from bypass mode */
    USB_CMD_GET_MCU_VERSION             = 26,                 /** \brief returns MCU SW version and build date */
