...
//    USB_CMD_RESET_TO_IDLE               = 20,                 /** \brief stop all continuous operations, set all pins to default state, wait for new command */
    USB_CMD_START_MONITORING_WATCHDOG   = 21,                 /** \brief enables MCU functionality that sends values of Watchdog status registers and time durations between the polls to GUI; continuous command */
    USB_CMD_STOP_MONITORING_WATCHDOG    = 22,                 /** \brief disables MCU functionality that sends values of Watchdog status registers and time durations between the polls to GUI */
//    USB_CMD_BYPASS_MCU                  = 23,                 /** \brief sets MCU to bypass mode (not interfering external MCU communication) */
//    USB_CMD_ACTIVATE_MCU                = 24,                 /** \brief activates MCU, exits from bypass mode */
    USB_CMD_GET_MCU_VERSION             = 25,                 /** \brief returns MCU SW version */
    USB_CMD_GET_MCU_BUILD_DATE          = 26,                 /** \brief returns MCU SW build date */
    USB_CMD_GET_MCU_BUILD_TIME          = 27,                 /** \brief returns MCU SW build time */
    USB_CMD_SET_EXT_OSC_2MHZ            = 28,                 /** \brief sets external clock output to 2Mhz */
    USB_CMD_SET_EXT_OSC_4MHZ            = 29,                 /** \brief sets external clock output to 4Mhz  */
