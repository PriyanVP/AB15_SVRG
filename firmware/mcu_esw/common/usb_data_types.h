...
typedef enum
{
    ...
    USB_CMD_READ_REG                    = 4,                  /** \brief read single register, otput data in raw format, reports error if unsuccessful */
    USB_CMD_WRITE_REG                   = 5,                  /** \brief write single register, otput data in raw format, reports error if unsuccessful */
    USB_CMD_CONFIGURE_READING           = 6,                  /** \brief reconfigure continuos reading (table, periodiciyr, etc.) */
