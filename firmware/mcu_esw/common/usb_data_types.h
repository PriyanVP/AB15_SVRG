...
typedef enum
{
    ...
    USB_CMD_READ_REG                    = 2,                  /** \brief read single register, reports error if unsuccessful */
    USB_CMD_WRITE_REG                   = 3,                  /** \brief write single register, reports error if unsuccessful */
