...
public enum MCUCommand
{
    ...
    READ_REG                    = 4,                  /** \brief read single register, output data in raw format, reports error if unsuccessful */
    WRITE_REG                   = 5,                  /** \brief write single register, output data in raw format, reports error if unsuccessful */
    CONFIGURE_READING           = 6,                  /** \brief reconfigure continuos reading (table, periodicity, etc.) */
    ...
    FLM_DIAG_ENABLE             = 23,                 /** \brief enables Firing Loop Module cyclic diagnostics */
    FLM_DIAG_READ_RESULTS       = 24,                 /** \brief returns results of Firing Loop Module cyclic diagnostics */
    ...
    RESET_MCU                   = 34,                 /** \brief resets ShieldBuddy */
    SET_SVR                     = 35,                 /** \brief set SVR pin */
