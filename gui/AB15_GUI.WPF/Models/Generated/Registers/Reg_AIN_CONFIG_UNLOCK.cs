...
{
    /// <summary>
    /// Class for working with AIN_CONFIG_UNLOCK register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_AIN_CONFIG_UNLOCK : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "AIN_CONFIG_UNLOCK";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x008c;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "AIN Config Channel Unlock";
        ...
        /// <summary>
        /// AIN Config Channel Unlock (only active when Safing IP is used)
        /// Bitwidth: 10
        /// </summary>
        public Field_ain_config_unlock ain_config_unlock { get; set; } = new Field_ain_config_unlock();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= ain_config_unlock.GetPositionalValue();
                
                return data;
            }
            set
            {
                ain_config_unlock.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with ain_config_unlock field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_ain_config_unlock
        {
            /// <summary>
            ...
            /// Description
            /// </summary>
            public string Description { get; private set; } = "AIN Config Channel Unlock (only active when Safing IP is used)";
