...
{
    /// <summary>
    /// Class for working with FLM_Read_Diag_SVRG_GATE register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_FLM_Read_Diag_SVRG_GATE : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "FLM_Read_Diag_SVRG_GATE";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x01ad;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "FLM result of SVRG_GATE diagnosis";
        ...
        /// <summary>
        /// SVRG_GATE voltage valid
        /// Bitwidth: 1
        /// </summary>
        public Field_flm_svrg_gate_voltage_valid flm_svrg_gate_voltage_valid { get; set; } = new Field_flm_svrg_gate_voltage_valid();
        
        /// <summary>
        /// SVRG_GATE voltage
        /// Bitwidth: 12
        /// </summary>
        public Field_flm_svrg_gate_voltage_value flm_svrg_gate_voltage_value { get; set; } = new Field_flm_svrg_gate_voltage_value();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= flm_svrg_gate_voltage_valid.GetPositionalValue();
                data |= flm_svrg_gate_voltage_value.GetPositionalValue();
                
                return data;
            }
            set
            {
                flm_svrg_gate_voltage_valid.UpdateValue(value);
                flm_svrg_gate_voltage_value.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with flm_svrg_gate_voltage_valid field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_svrg_gate_voltage_valid
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_svrg_gate_voltage_valid";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "SVRG_GATE voltage valid";
        ...
        /// <summary>
        /// Class for working with flm_svrg_gate_voltage_value field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_svrg_gate_voltage_value
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_svrg_gate_voltage_value";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "SVRG_GATE voltage";
