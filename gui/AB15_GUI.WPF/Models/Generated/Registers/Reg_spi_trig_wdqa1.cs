...
{
    /// <summary>
    /// Class for working with spi_trig_wdqa1 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_spi_trig_wdqa1 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "spi_trig_wdqa1";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0039;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "QA1 Message Response Register.";
        ...
        /// Bitwidth: 16
        /// </summary>
        public Field_spi_set_qa1cmd spi_set_qa1cmd { get; set; } = new Field_spi_set_qa1cmd();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= spi_set_qa1cmd.GetPositionalValue();
                
                return data;
            }
            set
            {
                spi_set_qa1cmd.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with spi_set_qa1cmd field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_spi_set_qa1cmd
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "spi_set_qa1cmd";
