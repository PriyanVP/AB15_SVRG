...
{
    /// <summary>
    /// Class for working with SWMON2_Config_Lower_Limit_B2 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_SWMON2_Config_Lower_Limit_B2 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "SWMON2_Config_Lower_Limit_B2";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0130;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "Configure lower limit for band 2 range comparison for SWMON2";
        ...
        /// <summary>
        /// Lower limit for band2 range comparison
        /// Bitwidth: 12
        /// </summary>
        public Field_sw2_lower_limit_band2 sw2_lower_limit_band2 { get; set; } = new Field_sw2_lower_limit_band2();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= sw2_lower_limit_band2.GetPositionalValue();
                
                return data;
            }
            set
            {
                sw2_lower_limit_band2.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with sw2_lower_limit_band2 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_sw2_lower_limit_band2
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "sw2_lower_limit_band2";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "Lower limit for band2 range comparison";
