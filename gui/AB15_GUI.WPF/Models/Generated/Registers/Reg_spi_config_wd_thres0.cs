...
{
    /// <summary>
    /// Class for working with spi_config_wd_thres0 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_spi_config_wd_thres0 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "spi_config_wd_thres0";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0033;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "Config Register WD1";
        ...
        /// <summary>
        /// EN0 disable threshold WD2.
        /// Bitwidth: 6
        /// </summary>
        public Field_spi_set_en0_thre_wd2 spi_set_en0_thre_wd2 { get; set; } = new Field_spi_set_en0_thre_wd2();
        
        /// <summary>
        /// EN0 disable threshold WD1.
        /// Bitwidth: 6
        /// </summary>
        public Field_spi_set_en0_thre_wd1 spi_set_en0_thre_wd1 { get; set; } = new Field_spi_set_en0_thre_wd1();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= spi_set_en0_thre_wd2.GetPositionalValue();
                data |= spi_set_en0_thre_wd1.GetPositionalValue();
                
                return data;
            }
            set
            {
                spi_set_en0_thre_wd2.UpdateValue(value);
                spi_set_en0_thre_wd1.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with spi_set_en0_thre_wd2 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_spi_set_en0_thre_wd2
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "spi_set_en0_thre_wd2";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "EN0 disable threshold WD2.";
        ...
        /// <summary>
        /// Class for working with spi_set_en0_thre_wd1 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_spi_set_en0_thre_wd1
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "spi_set_en0_thre_wd1";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "EN0 disable threshold WD1.";
