...
{
    /// <summary>
    /// Class for working with spi_trig_wdqa2 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_spi_trig_wdqa2 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "spi_trig_wdqa2";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x003a;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "QA2 Message Response Register.";
        ...
        /// Bitwidth: 16
        /// </summary>
        public Field_spi_set_qa2cmd spi_set_qa2cmd { get; set; } = new Field_spi_set_qa2cmd();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= spi_set_qa2cmd.GetPositionalValue();
                
                return data;
            }
            set
            {
                spi_set_qa2cmd.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with spi_set_qa2cmd field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_spi_set_qa2cmd
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "spi_set_qa2cmd";
