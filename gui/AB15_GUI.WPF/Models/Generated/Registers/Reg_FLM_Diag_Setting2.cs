...
{
    /// <summary>
    /// Class for working with FLM_Diag_Setting2 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_FLM_Diag_Setting2 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "FLM_Diag_Setting2";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x01a9;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "Diagnosis setting2";
        ...
        /// <summary>
        /// Maximum threshold for FLM capacity detection diagnosis. Multiples of 1us. Value is additionally used to decrease Powerstage test timeout
        /// Bitwidth: 12
        /// </summary>
        public Field_flm_diag_cap_time_max flm_diag_cap_time_max { get; set; } = new Field_flm_diag_cap_time_max();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= flm_diag_cap_time_max.GetPositionalValue();
                
                return data;
            }
            set
            {
                flm_diag_cap_time_max.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with flm_diag_cap_time_max field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_diag_cap_time_max
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_diag_cap_time_max";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "Maximum threshold for FLM capacity detection diagnosis. Multiples of 1us. Value is additionally used to decrease Powerstage test timeout";
