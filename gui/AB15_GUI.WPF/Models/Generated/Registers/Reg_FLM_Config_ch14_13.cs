...
{
    /// <summary>
    /// Class for working with FLM_Config_ch14_13 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_FLM_Config_ch14_13 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "FLM_Config_ch14_13";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0186;
        ...
        /// Bitwidth: 5
        /// </summary>
        public Field_flm_mode_ch14 flm_mode_ch14 { get; set; } = new Field_flm_mode_ch14();
        
        /// <summary>
        /// parity bit covering firing mode on selected firing loop
        /// Bitwidth: 1
        /// </summary>
        public Field_flm_mode_parity_ch14 flm_mode_parity_ch14 { get; set; } = new Field_flm_mode_parity_ch14();
        
        /// <summary>
        /// firing mode for selected firing loop
        /// Bitwidth: 5
        /// </summary>
        public Field_flm_mode_ch13 flm_mode_ch13 { get; set; } = new Field_flm_mode_ch13();
        
        /// <summary>
        /// parity bit covering firing mode on selected firing loop
        /// Bitwidth: 1
        /// </summary>
        public Field_flm_mode_parity_ch13 flm_mode_parity_ch13 { get; set; } = new Field_flm_mode_parity_ch13();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= flm_mode_ch14.GetPositionalValue();
                data |= flm_mode_parity_ch14.GetPositionalValue();
                data |= flm_mode_ch13.GetPositionalValue();
                data |= flm_mode_parity_ch13.GetPositionalValue();
                
                return data;
            }
            set
            {
                flm_mode_ch14.UpdateValue(value);
                flm_mode_parity_ch14.UpdateValue(value);
                flm_mode_ch13.UpdateValue(value);
                flm_mode_parity_ch13.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with flm_mode_ch14 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_ch14
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_ch14";
        ...
        /// <summary>
        /// Class for working with flm_mode_parity_ch14 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_parity_ch14
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_parity_ch14";
        ...
        /// <summary>
        /// Class for working with flm_mode_ch13 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_ch13
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_ch13";
        ...
        /// <summary>
        /// Class for working with flm_mode_parity_ch13 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_parity_ch13
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_parity_ch13";
