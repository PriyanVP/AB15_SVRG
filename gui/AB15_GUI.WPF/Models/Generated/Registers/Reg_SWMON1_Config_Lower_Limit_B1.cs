...
{
    /// <summary>
    /// Class for working with SWMON1_Config_Lower_Limit_B1 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_SWMON1_Config_Lower_Limit_B1 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "SWMON1_Config_Lower_Limit_B1";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0129;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "Configure lower limit for band 1 range comparison for SWMON1";
        ...
        /// <summary>
        /// Lower limit for band1 range comparison
        /// Bitwidth: 12
        /// </summary>
        public Field_sw1_lower_limit_band1 sw1_lower_limit_band1 { get; set; } = new Field_sw1_lower_limit_band1();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= sw1_lower_limit_band1.GetPositionalValue();
                
                return data;
            }
            set
            {
                sw1_lower_limit_band1.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with sw1_lower_limit_band1 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_sw1_lower_limit_band1
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "sw1_lower_limit_band1";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "Lower limit for band1 range comparison";
