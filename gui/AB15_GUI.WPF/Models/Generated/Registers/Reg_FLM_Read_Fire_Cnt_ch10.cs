...
{
    /// <summary>
    /// Class for working with FLM_Read_Fire_Cnt_ch10 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_FLM_Read_Fire_Cnt_ch10 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "FLM_Read_Fire_Cnt_ch10";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0197;
