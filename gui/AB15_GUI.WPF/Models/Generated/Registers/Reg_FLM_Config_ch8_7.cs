...
{
    /// <summary>
    /// Class for working with FLM_Config_ch8_7 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_FLM_Config_ch8_7 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "FLM_Config_ch8_7";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0183;
        ...
        /// Bitwidth: 5
        /// </summary>
        public Field_flm_mode_ch8 flm_mode_ch8 { get; set; } = new Field_flm_mode_ch8();
        
        /// <summary>
        /// parity bit covering firing mode on selected firing loop
        /// Bitwidth: 1
        /// </summary>
        public Field_flm_mode_parity_ch8 flm_mode_parity_ch8 { get; set; } = new Field_flm_mode_parity_ch8();
        
        /// <summary>
        /// firing mode for selected firing loop
        /// Bitwidth: 5
        /// </summary>
        public Field_flm_mode_ch7 flm_mode_ch7 { get; set; } = new Field_flm_mode_ch7();
        
        /// <summary>
        /// parity bit covering firing mode on selected firing loop
        /// Bitwidth: 1
        /// </summary>
        public Field_flm_mode_parity_ch7 flm_mode_parity_ch7 { get; set; } = new Field_flm_mode_parity_ch7();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= flm_mode_ch8.GetPositionalValue();
                data |= flm_mode_parity_ch8.GetPositionalValue();
                data |= flm_mode_ch7.GetPositionalValue();
                data |= flm_mode_parity_ch7.GetPositionalValue();
                
                return data;
            }
            set
            {
                flm_mode_ch8.UpdateValue(value);
                flm_mode_parity_ch8.UpdateValue(value);
                flm_mode_ch7.UpdateValue(value);
                flm_mode_parity_ch7.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with flm_mode_ch8 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_ch8
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_ch8";
        ...
        /// <summary>
        /// Class for working with flm_mode_parity_ch8 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_parity_ch8
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_parity_ch8";
        ...
        /// <summary>
        /// Class for working with flm_mode_ch7 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_ch7
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_ch7";
        ...
        /// <summary>
        /// Class for working with flm_mode_parity_ch7 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_parity_ch7
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_parity_ch7";
