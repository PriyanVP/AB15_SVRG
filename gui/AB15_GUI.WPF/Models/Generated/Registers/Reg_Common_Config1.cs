...
{
    /// <summary>
    /// Class for working with Common_Config1 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_Common_Config1 : IRegister
    {
        /// <summary>
        /// Reset value for register
        /// </summary>
        public UInt16 ResetValue { get; private set; } = 0x7;

        /// <summary>
        /// Name of the register
        /// </summary>
        public string Name { get; private set; } = "Common_Config1";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x001a;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "Common configuration register 1      ";
        ...
        /// <summary>
        /// Out Of Frame PSI sensor ID       
        /// Bitwidth: 2
        /// </summary>
        public Field_psi_slave_id psi_slave_id { get; set; } = new Field_psi_slave_id();
        
        /// <summary>
        /// Threshold for oscmon1 error filter. Error is        qualified if filter reaches or exceeds value       
        /// Bitwidth: 3
        /// </summary>
        public Field_oscmon1_err_thres oscmon1_err_thres { get; set; } = new Field_oscmon1_err_thres();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= psi_slave_id.GetPositionalValue();
                data |= oscmon1_err_thres.GetPositionalValue();
                
                return data;
            }
            set
            {
                psi_slave_id.UpdateValue(value);
                oscmon1_err_thres.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with psi_slave_id field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_psi_slave_id
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "psi_slave_id";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "Out Of Frame PSI sensor ID       ";
        ...
        /// <summary>
        /// Class for working with oscmon1_err_thres field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_oscmon1_err_thres
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "oscmon1_err_thres";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "Threshold for oscmon1 error filter. Error is        qualified if filter reaches or exceeds value       ";
