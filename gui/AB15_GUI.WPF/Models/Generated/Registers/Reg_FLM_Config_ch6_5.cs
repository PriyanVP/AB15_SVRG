...
{
    /// <summary>
    /// Class for working with FLM_Config_ch6_5 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_FLM_Config_ch6_5 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "FLM_Config_ch6_5";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0182;
        ...
        /// Bitwidth: 5
        /// </summary>
        public Field_flm_mode_ch6 flm_mode_ch6 { get; set; } = new Field_flm_mode_ch6();
        
        /// <summary>
        /// parity bit covering firing mode on selected firing loop
        /// Bitwidth: 1
        /// </summary>
        public Field_flm_mode_parity_ch6 flm_mode_parity_ch6 { get; set; } = new Field_flm_mode_parity_ch6();
        
        /// <summary>
        /// firing mode for selected firing loop
        /// Bitwidth: 5
        /// </summary>
        public Field_flm_mode_ch5 flm_mode_ch5 { get; set; } = new Field_flm_mode_ch5();
        
        /// <summary>
        /// parity bit covering firing mode on selected firing loop
        /// Bitwidth: 1
        /// </summary>
        public Field_flm_mode_parity_ch5 flm_mode_parity_ch5 { get; set; } = new Field_flm_mode_parity_ch5();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= flm_mode_ch6.GetPositionalValue();
                data |= flm_mode_parity_ch6.GetPositionalValue();
                data |= flm_mode_ch5.GetPositionalValue();
                data |= flm_mode_parity_ch5.GetPositionalValue();
                
                return data;
            }
            set
            {
                flm_mode_ch6.UpdateValue(value);
                flm_mode_parity_ch6.UpdateValue(value);
                flm_mode_ch5.UpdateValue(value);
                flm_mode_parity_ch5.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with flm_mode_ch6 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_ch6
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_ch6";
        ...
        /// <summary>
        /// Class for working with flm_mode_parity_ch6 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_parity_ch6
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_parity_ch6";
        ...
        /// <summary>
        /// Class for working with flm_mode_ch5 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_ch5
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_ch5";
        ...
        /// <summary>
        /// Class for working with flm_mode_parity_ch5 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_parity_ch5
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_parity_ch5";
