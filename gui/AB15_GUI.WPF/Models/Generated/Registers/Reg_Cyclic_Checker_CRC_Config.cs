...
{
    /// <summary>
    /// Class for working with Cyclic_Checker_CRC_Config register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_Cyclic_Checker_CRC_Config : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "Cyclic_Checker_CRC_Config";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0020;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "Cyclic Checker reference crc for customer      ";
        ...
        /// Bitwidth: 16
        /// </summary>
        public Field_cyclic_checker_ref_crc cyclic_checker_ref_crc { get; set; } = new Field_cyclic_checker_ref_crc();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= cyclic_checker_ref_crc.GetPositionalValue();
                
                return data;
            }
            set
            {
                cyclic_checker_ref_crc.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with cyclic_checker_ref_crc field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_cyclic_checker_ref_crc
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "cyclic_checker_ref_crc";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "Register name";
