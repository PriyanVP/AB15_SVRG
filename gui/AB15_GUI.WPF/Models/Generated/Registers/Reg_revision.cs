...
namespace AB15_GUI.WPF.Models.Generated.Registers
{
    ...
    public class Reg_revision
    {
        ...
        /// </summary>
        public string Name { get; private set; } = "revision";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0002;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "revision in chip identifier)      ";
        ...
        /// <summary>
        /// revision in chip identifier, for AA = 01       
        /// Bitwidth: 8
        /// </summary>
        public Field_id id { get; set; } = new Field_id();
        ...
        /// <summary>
        /// Class for working with id field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_id
        {
            /// <summary>
            ...
            /// Description
            /// </summary>
            public string Description { get; private set; } = "revision in chip identifier, for AA = 01       ";
