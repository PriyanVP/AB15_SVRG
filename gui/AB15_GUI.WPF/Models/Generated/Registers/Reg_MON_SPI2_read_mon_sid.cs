...
{
    /// <summary>
    /// Class for working with MON_SPI2_read_mon_sid register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_MON_SPI2_read_mon_sid : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "MON_SPI2_read_mon_sid";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0145;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "SPI MON2 read monitored SID and Status";
        ...
        /// <summary>
        /// monitored S0 Flag on SPI MON2
        /// Bitwidth: 1
        /// </summary>
        public Field_MON_SPI2_S0_Flag MON_SPI2_S0_Flag { get; set; } = new Field_MON_SPI2_S0_Flag();
        
        /// <summary>
        /// monitored error on SPI MON2
        /// Bitwidth: 1
        /// </summary>
        public Field_MON_SPI2_Error MON_SPI2_Error { get; set; } = new Field_MON_SPI2_Error();
        
        /// <summary>
        /// monitored SID on SPI MON2
        /// Bitwidth: 5
        /// </summary>
        public Field_MON_SPI2_Sid MON_SPI2_Sid { get; set; } = new Field_MON_SPI2_Sid();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= MON_SPI2_S0_Flag.GetPositionalValue();
                data |= MON_SPI2_Error.GetPositionalValue();
                data |= MON_SPI2_Sid.GetPositionalValue();
                
                return data;
            }
            set
            {
                MON_SPI2_S0_Flag.UpdateValue(value);
                MON_SPI2_Error.UpdateValue(value);
                MON_SPI2_Sid.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with MON_SPI2_S0_Flag field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_MON_SPI2_S0_Flag
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "MON_SPI2_S0_Flag";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "monitored S0 Flag on SPI MON2";
        ...
        /// <summary>
        /// Class for working with MON_SPI2_Error field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_MON_SPI2_Error
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "MON_SPI2_Error";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "monitored error on SPI MON2";
        ...
        /// <summary>
        /// Class for working with MON_SPI2_Sid field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_MON_SPI2_Sid
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "MON_SPI2_Sid";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "monitored SID on SPI MON2";
