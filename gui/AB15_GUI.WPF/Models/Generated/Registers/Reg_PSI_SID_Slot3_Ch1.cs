...
{
    /// <summary>
    /// Class for working with PSI_SID_Slot3_Ch1 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_PSI_SID_Slot3_Ch1 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "PSI_SID_Slot3_Ch1";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0092;
        ...
        /// Bitwidth: 2
        /// </summary>
        public Field_psi_format_slot3_ch1 psi_format_slot3_ch1 { get; set; } = new Field_psi_format_slot3_ch1();
        
        /// <summary>
        /// sensor ID for timing slot 3 of psi channel 1
        /// Bitwidth: 5
        /// </summary>
        public Field_psi_sid_slot3_ch1 psi_sid_slot3_ch1 { get; set; } = new Field_psi_sid_slot3_ch1();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= psi_format_slot3_ch1.GetPositionalValue();
                data |= psi_sid_slot3_ch1.GetPositionalValue();
                
                return data;
            }
            set
            {
                psi_format_slot3_ch1.UpdateValue(value);
                psi_sid_slot3_ch1.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with psi_format_slot3_ch1 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_psi_format_slot3_ch1
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "psi_format_slot3_ch1";
        ...
        /// <summary>
        /// Class for working with psi_sid_slot3_ch1 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_psi_sid_slot3_ch1
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Description
            /// </summary>
            public string Description { get; private set; } = "sensor ID for timing slot 3 of psi channel 1";
