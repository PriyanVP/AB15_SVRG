...
{
    /// <summary>
    /// Class for working with SMON_Config_Long register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_SMON_Config_Long : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "SMON_Config_Long";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0124;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "Config and enable the Long functionality";
        ...
        /// <summary>
        /// select channel used for DIS_AHP_long function
        /// Bitwidth: 5
        /// </summary>
        public Field_smon_dis_ahp_long_ch smon_dis_ahp_long_ch { get; set; } = new Field_smon_dis_ahp_long_ch();
        
        /// <summary>
        /// 1: enable DIS_AHP_long function, 0: disable
        /// Bitwidth: 1
        /// </summary>
        public Field_smon_dis_ahp_long_en smon_dis_ahp_long_en { get; set; } = new Field_smon_dis_ahp_long_en();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= smon_dis_ahp_long_ch.GetPositionalValue();
                data |= smon_dis_ahp_long_en.GetPositionalValue();
                
                return data;
            }
            set
            {
                smon_dis_ahp_long_ch.UpdateValue(value);
                smon_dis_ahp_long_en.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with smon_dis_ahp_long_ch field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_smon_dis_ahp_long_ch
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "smon_dis_ahp_long_ch";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "select channel used for DIS_AHP_long function";
        ...
        /// <summary>
        /// Class for working with smon_dis_ahp_long_en field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_smon_dis_ahp_long_en
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "smon_dis_ahp_long_en";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "1: enable DIS_AHP_long function, 0: disable";
