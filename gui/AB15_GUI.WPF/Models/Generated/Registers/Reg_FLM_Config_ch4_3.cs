...
{
    /// <summary>
    /// Class for working with FLM_Config_ch4_3 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_FLM_Config_ch4_3 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "FLM_Config_ch4_3";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0181;
        ...
        /// Bitwidth: 5
        /// </summary>
        public Field_flm_mode_ch4 flm_mode_ch4 { get; set; } = new Field_flm_mode_ch4();
        
        /// <summary>
        /// parity bit covering firing mode on selected firing loop
        /// Bitwidth: 1
        /// </summary>
        public Field_flm_mode_parity_ch4 flm_mode_parity_ch4 { get; set; } = new Field_flm_mode_parity_ch4();
        
        /// <summary>
        /// firing mode for selected firing loop
        /// Bitwidth: 5
        /// </summary>
        public Field_flm_mode_ch3 flm_mode_ch3 { get; set; } = new Field_flm_mode_ch3();
        
        /// <summary>
        /// parity bit covering firing mode on selected firing loop
        /// Bitwidth: 1
        /// </summary>
        public Field_flm_mode_parity_ch3 flm_mode_parity_ch3 { get; set; } = new Field_flm_mode_parity_ch3();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= flm_mode_ch4.GetPositionalValue();
                data |= flm_mode_parity_ch4.GetPositionalValue();
                data |= flm_mode_ch3.GetPositionalValue();
                data |= flm_mode_parity_ch3.GetPositionalValue();
                
                return data;
            }
            set
            {
                flm_mode_ch4.UpdateValue(value);
                flm_mode_parity_ch4.UpdateValue(value);
                flm_mode_ch3.UpdateValue(value);
                flm_mode_parity_ch3.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with flm_mode_ch4 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_ch4
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_ch4";
        ...
        /// <summary>
        /// Class for working with flm_mode_parity_ch4 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_parity_ch4
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_parity_ch4";
        ...
        /// <summary>
        /// Class for working with flm_mode_ch3 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_ch3
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_ch3";
        ...
        /// <summary>
        /// Class for working with flm_mode_parity_ch3 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_parity_ch3
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_parity_ch3";
