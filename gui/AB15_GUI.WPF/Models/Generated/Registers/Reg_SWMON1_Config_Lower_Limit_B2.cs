...
{
    /// <summary>
    /// Class for working with SWMON1_Config_Lower_Limit_B2 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_SWMON1_Config_Lower_Limit_B2 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "SWMON1_Config_Lower_Limit_B2";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x012b;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "Configure lower limit for band 2 range comparison for SWMON1";
        ...
        /// Bitwidth: 12
        /// </summary>
        public Field_sw1_lower_limit_band2 sw1_lower_limit_band2 { get; set; } = new Field_sw1_lower_limit_band2();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= sw1_lower_limit_band2.GetPositionalValue();
                
                return data;
            }
            set
            {
                sw1_lower_limit_band2.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with sw1_lower_limit_band2 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_sw1_lower_limit_band2
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "sw1_lower_limit_band2";
