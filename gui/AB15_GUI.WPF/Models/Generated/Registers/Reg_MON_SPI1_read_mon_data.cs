...
{
    /// <summary>
    /// Class for working with MON_SPI1_read_mon_data register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_MON_SPI1_read_mon_data : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "MON_SPI1_read_mon_data";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0142;

        /// <summary>
        /// Description
        /// </summary>
        public string Description { get; private set; } = "SPI MON1 read monitored data";
        ...
        /// <summary>
        /// monitored data on SPI MON1
        /// Bitwidth: 16
        /// </summary>
        public Field_MON_SPI1_Data MON_SPI1_Data { get; set; } = new Field_MON_SPI1_Data();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= MON_SPI1_Data.GetPositionalValue();
                
                return data;
            }
            set
            {
                MON_SPI1_Data.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with MON_SPI1_Data field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_MON_SPI1_Data
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "MON_SPI1_Data";

            /// <summary>
            /// Description
            /// </summary>
            public string Description { get; private set; } = "monitored data on SPI MON1";
