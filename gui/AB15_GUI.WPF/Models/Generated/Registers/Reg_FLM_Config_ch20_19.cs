...
{
    /// <summary>
    /// Class for working with FLM_Config_ch20_19 register
    /// WARNING: this class is generated, do not modify manually!
    /// </summary>
    public class Reg_FLM_Config_ch20_19 : IRegister
    {
        /// <summary>
        ...
        /// </summary>
        public string Name { get; private set; } = "FLM_Config_ch20_19";

        /// <summary>
        /// Absolute address of the register
        /// </summary>
        public UInt16 Address { get; private set; } = 0x0189;
        ...
        /// Bitwidth: 5
        /// </summary>
        public Field_flm_mode_ch20 flm_mode_ch20 { get; set; } = new Field_flm_mode_ch20();
        
        /// <summary>
        /// parity bit covering firing mode on selected firing loop
        /// Bitwidth: 1
        /// </summary>
        public Field_flm_mode_parity_ch20 flm_mode_parity_ch20 { get; set; } = new Field_flm_mode_parity_ch20();
        
        /// <summary>
        /// firing mode for selected firing loop
        /// Bitwidth: 5
        /// </summary>
        public Field_flm_mode_ch19 flm_mode_ch19 { get; set; } = new Field_flm_mode_ch19();
        
        /// <summary>
        /// parity bit covering firing mode on selected firing loop
        /// Bitwidth: 1
        /// </summary>
        public Field_flm_mode_parity_ch19 flm_mode_parity_ch19 { get; set; } = new Field_flm_mode_parity_ch19();
        ...
        public UInt16 Data
        {
            get
            {
                ...
                data |= flm_mode_ch20.GetPositionalValue();
                data |= flm_mode_parity_ch20.GetPositionalValue();
                data |= flm_mode_ch19.GetPositionalValue();
                data |= flm_mode_parity_ch19.GetPositionalValue();
                
                return data;
            }
            set
            {
                flm_mode_ch20.UpdateValue(value);
                flm_mode_parity_ch20.UpdateValue(value);
                flm_mode_ch19.UpdateValue(value);
                flm_mode_parity_ch19.UpdateValue(value);
        ...
        /// <summary>
        /// Class for working with flm_mode_ch20 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_ch20
        {
            /// <summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_ch20";
        ...
        /// <summary>
        /// Class for working with flm_mode_parity_ch20 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_parity_ch20
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_parity_ch20";
        ...
        /// <summary>
        /// Class for working with flm_mode_ch19 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_ch19
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_ch19";
        ...
        /// <summary>
        /// Class for working with flm_mode_parity_ch19 field
        /// WARNING: this class is generated, do not modify manually!
        /// </summary>
        public sealed class Field_flm_mode_parity_ch19
        {
            /// <summary>
            /// Max value that can be stored in field
            /// </summary>
            ...
            /// Name of the field
            /// </summary>
            public string Name { get; private set; } = "flm_mode_parity_ch19";
