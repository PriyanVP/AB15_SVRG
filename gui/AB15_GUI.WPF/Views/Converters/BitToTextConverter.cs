...
{
    /// <summary>
    /// Convert int number to text
    /// </summary>
    public class BitToTextConverter : IValueConverter
    {
        /// <summary>
        /// Based on input values convert int number to string representing bit state
        /// </summary>
        /// <param name="value">unsigned value of input</param>
        /// <param name="parameter">string representing what bit to get</param>
        /// <returns></returns>
